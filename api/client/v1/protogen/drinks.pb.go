...
func (x *DrinkItem) GetMark() float32 {
	if x != nil {
		return x.Mark
	}
	return 0
...
func (x *DrinkOfDayResponse) GetMark() float32 {
	if x != nil {
		return x.Mark
	}
	return 0
...
func (x *DrinkResponse) GetMark() float32 {
	if x != nil {
		return x.Mark
	}
	return 0
...
var file_drinks_proto_rawDesc = []byte{
	...
	0x6d, 0x61, 0x72, 0x6b, 0x18, 0x05, 0x20, 0x01, 0x28, 0x02, 0x52, 0x04, 0x6d, 0x61, 0x72, 0x6b,
	...
	0x12, 0x12, 0x0a, 0x04, 0x6d, 0x61, 0x72, 0x6b, 0x18, 0x05, 0x20, 0x01, 0x28, 0x02, 0x52, 0x04,
